...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "tw-flex tw-h-10 tw-w-full tw-items-center tw-justify-between tw-rounded-md tw-border tw-border-neutral-200 tw-bg-white tw-px-3 tw-py-2 tw-text-sm tw-ring-offset-white tw-placeholder:text-neutral-500 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-neutral-950 focus:tw-ring-offset-2 disabled:tw-cursor-not-allowed disabled:tw-opacity-50 dark:tw-border-neutral-800 dark:tw-bg-neutral-950 dark:tw-ring-offset-neutral-950 dark:tw-placeholder:text-neutral-400 dark:focus:tw-ring-neutral-300",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn(
      "tw--mx-1 tw-my-1 tw-h-px tw-bg-neutral-100 dark:tw-bg-neutral-800",
      className
    )}
    {...props}
  />
